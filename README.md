...
* **Mutation file:** a file in [VCF format](https://samtools.github.io/hts-specs/VCFv4.2.pdf) which lists all SVs you want to analyze. Please see [test.sv.vcf]() as a template.
